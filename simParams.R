## Params are from a joint model -- I've basically given up the idea of using actual CF variables
## This set of parameters causes the "extreme" difference between Cox and SuperLearner
...
S_intercept <- -7.0  #was -13.5  #was -22.5
...
S_aux <- 2.0     #was 4.0 #was 7.1  #True parameter value for shape parameter for Weibull model

# Details of longitudinal data to be simulated
yobs <- 20    #was 25       #Maximum allowed number of longitudinal measurements for the biomarker 
fuptime <- 16 #was 20       #The maximum follow up time. This time will also be used as the censoring time 
...
# And how this relates to landmarking
